...
# add
# Reference link: https://github.com/HobbitLong/SupContrast/blob/8117ece43eea5a38fb154f587601ceeadbe416b3/losses.py#L11
class SupConLoss(nn.Module):
    ...
    def forward(self, features, labels=None, mask=None):
        ...
        contrast_feature = torch.cat(torch.unbind(features, dim=1), dim=0).reshape((-1, 1))
